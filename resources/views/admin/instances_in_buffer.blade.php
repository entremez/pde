    <div class="row mt-5">
    	<div class="col">
    		<h4>Casos con cambio pendiente de aprobar (<span id="number_instances_buffered">{{ $intancesBuffered->count() }}</span>)<span id="instances_buffered"><i class="fas fa-sort-down"></i></span><span id="instances_buffered_up" style="display: none"><i class="fas fa-sort-up"></i></span></h4>
