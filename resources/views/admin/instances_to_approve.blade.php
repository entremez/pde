    <div class="row mt-5">
    	<div class="col">
    		<h4>Casos a aprobar ({{ $instancesWaitingForApproval->count() }}) <span id="instances_to_approve"><i class="fas fa-sort-down"></i></span><span id="instances_to_approve_up" style="display: none"><i class="fas fa-sort-up"></i></span></h4>
