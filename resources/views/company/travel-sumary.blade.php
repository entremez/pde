...
<div class="row">
	<div class="col-md-7 pl-5">
		...
		<p class="text-left stairs-phrase" id="phrase"></p>
...
<div class="row mt-5">
	...
	<div class="row w-100 mt-3">
		<div class="col-md-12 view-more-recommendations">
			<a href="" target="_blank" class="btn btn-danger btn-view-more-service">Ver más proveedores <i class="fas fa-chevron-right"></i></a>
		</div>
	</div>
</div>
<div class="row mt-5">
...
<div class="row">
	...
	<div class="col-md-12 px-5 mt-5">
		...
		<a href="" target="_blank" class="btn btn-danger btn-view-more-service mt-5">Ver más fuentes de financiamiento <i class="fas fa-chevron-right"></i></a>
	</div>
</div>