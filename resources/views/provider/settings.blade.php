        ...
        <div class="row py-4">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="mail" class="form-control" value="{{ old('contact_email', $data->contact_email) }}" required>
                </div>
            </div>
        </div>
...
<div class="mb-3 dm-uploader" id="drag-and-drop-zone">
  <div class="form-row">
    ...
    <div class="col-md-3  d-md-block  d-sm-none align-grid image-container">
      <img src="{{ $data->imagen_logo }}" alt="sin imagen" class="w-100" id="imgSalida">
    </div>
  </div>
</div>
                            ...
                            <div class="service">
                                ...
                                <ul>
                                    @foreach($services as $service)
                                        ...
                                        <div class="form-check tooltip-chb" data-toggle="tooltip" data-placement="left" title="{{ $service->description }}">
